...
const Sidebar = () => {
  ...
  const {activeMenu, setActiveMenu, screenSize, isS} = useStateContext ();
      ...
      items-center">
        ...
        tracking-tight dark:text-white text-slate-900">
          ...
          <TooltipComponent content="Menu" position="BottomCenter">
            <button type="button" onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)} className="text-xl rounded-full p-3 hover:bg-light-gray
            mt-4 block ">
              <MdOutlineCancel />
            </button>
          </TooltipComponent>
